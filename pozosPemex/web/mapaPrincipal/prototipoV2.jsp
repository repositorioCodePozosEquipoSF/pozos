...
<!-- MENU HORIZONTAL -->
		...
		<script>
			...
			/* DATOS QUE SIRVIERON PARA EL EJEMPLO ESTATICO */
			...
			var pozos = [
			             ['Arco 1', 17,937652, -94,281566],
			             ['Astra 1', 25,529445, -95,207104],
			             ['Abkatunpol Chuc', 19.3523961, -90.7277168],
			             ['Litoral', 25.8662111, -97.5022043],
			             ['Pozo Cardenas', 17.95260646769184, -102.2332763671875],
			             ['Pozo Mazatlan', 23.261534167651835, -106.3751220703125],
			             ['Pozo Ensenada', 31.868227816180674, -116.60888671875],
			             ['Chenkan Pick', 19.14127614472221, -90.94482421875]
			           ];
			...
			'<p>Nombre_pozo: <a href="http://192.168.1.78:8080/pozosPemex/mapaPrincipal/infoPozo.jsp">'+
			'http://192.168.1.78:8080/pozosPemex/mapaPrincipal/infoPozo.jsp</a></p>'+
			'<p>Más información en: <a href="http://192.168.1.78:8080/pozosPemex/abrirXls.do"><img src="/pozosPemex/img/xls_image.jpg"/></a></p>';
			...
			//SIRVIO DE EJEMPLO CON DATOS ESTATICOS, YA NO SE USA
				...
				for (i = 0; i < pozos.length; i++) {
					...
					google.maps.event.addListener(marker, 
											...
											(function(marker, pozo, infowindow){
												return function(){
										          infowindow.setContent('<p align="left"  style="font-weight: bold;">'+pozo+'</p>'+cadena);
			...
			$(document).ready(function() {
				var mapProp = {
	  					center:{lat: 22.3052548, lng: -101.907679},
	  					zoom:5,
	  					mapTypeId:google.maps.MapTypeId.ROADMAP
	  				  };
				...
				$.getJSON('/staticJson/pozosInfo.json', function(pozosConsulta) {

					var elementoPozo = pozosConsulta.pozosConsulta.pozosConsulta;
					
					$.each(
							elementoPozo,
									function(i) {
										//alert("DENTRO EACH --> id= "+elementoPozo[i].id+" ::: "+elementoPozo[i].cve+" ::: "+ 
										//		elemento[i].direccion+" ::: "+elemento[i].descDireccion+" ::: "+
										//		elemento[i].descSubDireccion+" ::: "+elemento[i].descSubDireccion);
												//elementoPozo[i].pozo + " ::: "+ elementoPozo[i].latitud + " ::: "+ elementoPozo[i].longitud);

										var latlngset = new google.maps.LatLng(elementoPozo[i].latitud, elementoPozo[i].longitud);
										
									    var marker = new google.maps.Marker({ 
									    	  map: map,
											  title: elementoPozo[i].pozo,
											  position: latlngset,
											  icon: elementoPozo[i].indicador										      
											});

									    //alert("pozo="+pozo+" ::: latitud="+latitud+" ::: longitud="+longitud+" ::: indicador="+indicador);											
										var infowindow = new google.maps.InfoWindow();	
										var p = elementoPozo[i].pozo;
										//var a = elemento[i].descDireccion;
										//var cadena = "HOLA!!!"; 
										var cadena = "<div style='text-align: left;'>"+
										"<br><label style='text-align: left; font-weight: bold;'>Direccion: </label><lable>"+elementoPozo[i].descDireccion+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Subdireccion: </label><lable>"+elementoPozo[i].descSubDireccion+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Activo: </label><lable>"+elementoPozo[i].descActivo+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Unidad Operativa: </label><lable>"+elementoPozo[i].descUnidadOperativa+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Actividad: </label><lable>"+elementoPozo[i].descActividad+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Proyecto: </label><lable>"+elementoPozo[i].descProyecto+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Campo: </label><lable>"+elementoPozo[i].descCampo+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Tipo pozo: </label><lable>"+elementoPozo[i].tipoPozo+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Equipo: </label><lable>"+elementoPozo[i].descEquipo+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>No.Equipo: </label><lable>"+elementoPozo[i].numEquipo+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Cap.Equipo: </label><lable>"+elementoPozo[i].capEquipo+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Tipo contrato: </label><lable>"+elementoPozo[i].tipoContrato+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>U.TR: </label><lable>"+elementoPozo[i].utr+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Prox. TR: </label><lable>"+elementoPozo[i].proxTr+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Inclinacion: </label><lable>"+elementoPozo[i].inclinacion+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Desplazamiento: </label><lable>"+elementoPozo[i].desplazamiento+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Profundidad: </label><lable>"+elementoPozo[i].profundidad+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Fecha inicio: </label><lable>"+elementoPozo[i].fechaInicio+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Fecha termino: </label><lable>"+elementoPozo[i].fechaTermino+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Costo porg: </label><lable>"+elementoPozo[i].costoProg+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Costo real: </label><lable>"+elementoPozo[i].costoReal+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Formacion: </label><lable>"+elementoPozo[i].formacionObj+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Operacion: </label><lable>"+elementoPozo[i].operacion+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Estatus: </label><lable>"+elementoPozo[i].descEstatus+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Validado: </label><lable>"+elementoPozo[i].validado+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Obs: </label><lable>"+elementoPozo[i].obs+"</label>"+
										"<br><label style='text-align: left; font-weight: bold;'>Responsable: </label><lable>"+elementoPozo[i].responsable+"</label>"+
										"</div>";
										...
										google.maps.event.addListener(marker, 
												'click', 
												(function(marker, p, infowindow){
													return function(){
											          infowindow.setContent('<p align="left" style="font-weight: bold; text-decoration: underline;">Pozo: '+p+'</p>'+cadena);
											          infowindow.open(map, marker);
													};
						    		})(marker, p, infowindow));																	
